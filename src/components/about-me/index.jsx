            ...
            <div className="L-aboutMe-wrapper G-flex G-justify-between G-flex-wrap">
                ...
                <div className='L-aboutMe-child'>
                    ...
                    <p className='L-aboutMe-desc'>
                        ...
                        The main responsibilities  of my work include the layout of sites and landing pages, writing scripts in JS.
                        I mostly work with React JS` developing a user interfaces,
